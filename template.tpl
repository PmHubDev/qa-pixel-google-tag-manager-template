...

{
  ...
  "description": "The conversion event of Permate is recorded when the Conversion tag is placed on the Thank You page or the page where the event occurs.",
  "containerContexts": [
    "WEB"
  ]
}
...
Created on 12/6/2024, 4:01:45 PM
